<template>
  <div class="container mx-auto p-6 bg-gray-50 min-h-screen">
    <div>
      <p class="text-2xl text-gray-900 font-bold mb-4 mt-3 ml-2">Nuevo paciente</p>
          ...
          <div class="grid grid-cols-3 gap-6">
            ...
            <div class="flex flex-col">
              ...
              <input type="text" placeholder="" 
                class="border border-gray-300 rounded px-3 py-2 bg-white text-gray-600 focus:outline-none" />
            </div>
      ...
      <div v-if="activeTab === 'Cuestionarios'">
        ...
        <p><strong>Cuestionarios Completados:</strong> questions</p>
...
export default {
  ...
  data() {
    return {
      patient: null,
      activeTab: 'Datos', // Default active tab
      questions: [],
