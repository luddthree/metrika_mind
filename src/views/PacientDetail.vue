        ...
        <ul class="flex">
          <li class="mr-6">
            <a href="#"
              ...
              class="inline-block py-2 px-4 text-lg" @click.prevent="setActiveTab('Estadisicas')">
              Estadisicas
            </a>
          </li>
          <li class="mr-6">
            <a href="#"
              ...
              class="inline-block py-2 px-4 text-lg" @click.prevent="setActiveTab('Cuestionarios')">
              Cuestionarios
            </a>
          </li>
          <li class="mr-6">
            <a href="#" :class="activeTab === 'Alertas' ? 'text-black border-b-2 border-green-400' : 'text-gray-500'"
              class="inline-block py-2 px-4 text-lg" @click.prevent="setActiveTab('Alertas')">
              Alertas
            </a>
          </li>
          <li class="mr-6">
            <a href="#" :class="activeTab === 'Datos' ? 'text-black border-b-2 border-green-400' : 'text-gray-500'"
              class="inline-block py-2 px-4 text-lg" @click.prevent="setActiveTab('Datos')">
              Datos
            </a>
          </li>
          <li class="mr-6">
            <a href="#"
              ...
              class="inline-block py-2 px-4 text-lg" @click.prevent="setActiveTab('Consentimientos')">
              Consentimientos
            </a>
          </li>
        </ul>
        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="grid grid-cols-3 gap-6">
            ...
            <div class="flex flex-col">
              ...
              <input type="text" :placeholder="patient.name" readonly
            ...
            <div class="flex flex-col">
              ...
              <input type="text" :placeholder="patient.email" readonly
                class="border border-gray-300 rounded px-3 py-2 bg-gray-100 text-gray-600 focus:outline-none" />
            </div>
